    ...
    loadPizzas$ = this.actions$.pipe(
        ...
        switchMap(() =>
            this.pizzasService.getPizzas().pipe(
                ...
                catchError(error =>
                    of(new fromPizzaAction.LoadPizzasFailAction(error))
                )
            )
        )
    );
    ...
    createPizza$ = this.actions$.pipe(
        ...
        switchMap(pizza =>
            this.pizzasService.createPizza(pizza).pipe(
                map(
                    pizza => new fromPizzaAction.CreatePizzaSuccessAction(pizza)
                ),
                catchError(error =>
                    of(new fromPizzaAction.CreatePizzaFailAction(error))
                )
            )
        )
    );
    ...
    updatePizza$ = this.actions$.pipe(
        ...
        switchMap(pizza => {
            return this.pizzasService.updatePizza(pizza).pipe(
                map(
                    pizza => new fromPizzaAction.UpdatePizzaSuccessAction(pizza)
                ),
                catchError(error =>
                    of(new fromPizzaAction.UpdatePizzaFailAction(error))
                )
            );
        })
    );
    ...
    removePizza$ = this.actions$.pipe(
        ...
        switchMap(pizza => {
            return this.pizzasService.removePizza(pizza).pipe(
                ...
                catchError(error =>
                    of(new fromPizzaAction.RemovePizzaFailAction(error))
                )
            );
        })
    );
