...
export class RunLazyRuntimeComponent {
    ...
    constructor(private lazyRuntimeModuleService: LazyRuntimeModuleService) {}
    ...
    _loadRuntimeModule(): void {
        this.lazyRuntimeModuleService.load().then((ngModuleFactory: any) => {
            ...
            this.vcrRef.createComponent(
                ngModuleFactory.componentFactoryResolver.resolveComponentFactory(
                    ngModuleFactory._bootstrapComponents[0]
                )
            );
        });
    }
