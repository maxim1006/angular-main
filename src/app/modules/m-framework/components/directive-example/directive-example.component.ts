...
@Component({
    ...
    template: `
        ...
        Set color: <input autofocus type="text" (input)="c.changeColor($event.target.value)" style="border: 1px solid" />
...
export class MDirectiveExampleComponent implements OnInit {
    constructor() {
    }
