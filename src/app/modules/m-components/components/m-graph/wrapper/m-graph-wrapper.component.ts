...
import {
    ...
    CustomerProfileGraphModel, DatabaseActivityGraphModel,
...
export class MGraphWrapperComponent {
    ...
    public _journeysStatsGraphModel: Highcharts.ChartObject | any = JourneysStatsGraphModel;
    public _activityByJourneyTypeGraphModel: Highcharts.ChartObject | any = ActivityByJourneyTypeGraphModel;
    public _inboundActivityGraphModel: Highcharts.ChartObject | any = InboundActivityGraphModel;
    public _journeysLifecycleGraphModel: Highcharts.ChartObject | any = JourneysLifecycleGraphModel;
    public _databaseActivityGraphModel: Highcharts.ChartObject | any = DatabaseActivityGraphModel;
