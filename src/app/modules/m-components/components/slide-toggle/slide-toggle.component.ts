...
@Component({
    ...
    template: `
        ...
        >
            ...
            aliquam at blanditiis deleniti deserunt doloremque doloribus illum
            iusto natus necessitatibus obcaecati odit perferendis provident
            quibusdam quidem, repellendus, reprehenderit repudiandae sequi.
        </div>
    `,
})
export class MSlideToggleComponent {
    @HostBinding("class")
