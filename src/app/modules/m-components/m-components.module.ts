...
const routes: Routes = [{ path: "", component: MComponentsComponent }];
...
@NgModule({
    ...
    declarations: [
        ...components,
        ...directives,
        MGridExampleComponent,
        IntercectionObserverComponent,
        AsyncAwaitComponent,
        KeydownComponent,
        ConsoleExamplesComponent,
        LinkBlankComponent,
        NetworkEffectiveTipeComponent,
        InheritanceCompositionComponent,
        DebounceComponent,
        ThrottleComponent,
        MapComponent,
